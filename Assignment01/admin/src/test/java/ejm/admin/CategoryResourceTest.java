...
public class CategoryResourceTest {
    ...
    public void eUpdateCategory() {
        ...
        Category category = JsonPath.from(response.asString()).getObject("", Category.class);
        ...
        Category updatedCategory = JsonPath.from(updateResponse.asString()).getObject("", Category.class);

        assertThat(updatedCategory.getName()).isEqualTo("newName");
    }

    @Test
    public void fFailToUpdateCategoryIdNotExists() {
        // try to update category with non existing id 1
        ...
        assertThat(response.getBody().asString()).contains("Category with id of " + categoryId + " does not exist.");
    }

    @Test
    public void gRemoveCategory() {
        // remove category with id 1019
        Integer categoryId = 1019;
        ...
        // try to get category with id 1019
    ...
    @Test
    public void hFailToRemoveCategoryIdNotExists() {
        // try to remove category with non existing id 1
